...
namespace Assignment_One___OOP___Nathan_Yates
{
    public partial class winScreen : Form
    {
        ...
        private void winScreen_Load(object sender, EventArgs e) // Updates jumper, background images, and displays the coin count, time alive and game difficulty
        {
        ...
        private void gameBtn_Click(object sender, EventArgs e)  // Opens game screen, closes win screen.
        {
        ...
        private void exitBtn_Click(object sender, EventArgs e) // Opens menu screen, closes win screen.
        {
